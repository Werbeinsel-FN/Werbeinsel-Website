...
/* ----- Novo: wrapper sa bočnim thumbnailovima ----- */
.wi-hero-wrap{
  position:relative;
  display:flex; align-items:center; gap:8px;
  height:50vh; min-height:400px;
}
@media (min-width:640px){ .wi-hero-wrap{ height:60vh; min-height:500px } }
@media (min-width:1024px){ .wi-hero-wrap{ height:70vh } }
...
.wi-h1{
  font-size:clamp(22px, 3.3vw, 50px);   /* manji nego pre */
  line-height:1.1;
  margin-bottom:8px;
  letter-spacing:-.01em;
  font-weight:800;
...
.wi-h2{
  font-size:clamp(12px, 1.6vw, 32px);   /* manji podnaslov */
  line-height:1.2;
  margin-bottom:6px;
  font-weight:700;
}
