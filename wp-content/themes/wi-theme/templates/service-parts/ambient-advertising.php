<?php
/**
 * Partial: Ambient Advertising – hero (naslov + slider) + intro (editabilno)
...
$meta = function_exists('wi_get_ambient_meta') ? wi_get_ambient_meta($page_id) : [];
...
if (empty($slides)) {
  ...
  $slides = [
    'https://picsum.photos/id/1400/1600/900',
    'https://picsum.photos/id/1401/1600/900',
    'https://picsum.photos/id/1402/1600/900',
  ];
}
...
$intro_text = !empty($meta['intro_text'])
  ? $meta['intro_text']
  : 'Ambient Advertising nutzt alltägliche Orte und Objekte für überraschende Markeninszenierungen. WERBEINSEL plant, produziert und realisiert aufmerksamkeitsstarke Installationen im urbanen Raum – genau dort, wo Menschen täglich vorbeikommen.';
?>
