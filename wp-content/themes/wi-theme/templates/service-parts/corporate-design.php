<?php
/**
 * Partial: Corporate Design – hero (naslov + slider) + intro (editabilno)
...
$meta = function_exists('wi_get_corporate_meta') ? wi_get_corporate_meta($page_id) : [];
...
if (empty($slides)) {
  ...
  $slides = [
    'https://picsum.photos/id/1500/1600/900',
    'https://picsum.photos/id/1501/1600/900',
    'https://picsum.photos/id/1502/1600/900',
  ];
}
...
$intro_text = !empty($meta['intro_text'])
  ? $meta['intro_text']
  : 'Corporate Design definiert das visuelle Erscheinungsbild Ihrer Marke – Logo, Typografie, Farben, Bildsprache und Anwendungen. WERBEINSEL entwickelt konsistente Designsysteme und Styleguides, die auf allen Kanälen wirken – digital und analog.';
?>
