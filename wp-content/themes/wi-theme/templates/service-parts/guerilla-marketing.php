<?php
/**
 * Partial: Guerilla Marketing – hero (naslov + slider) + intro (editabilno)
 * Vidi: $slug, $svc, $page_title, $page_id
 */

/* Page-specific CSS (po želji, ne menja izgled strelica) */
...
$meta = function_exists('wi_get_guerilla_meta') ? wi_get_guerilla_meta($page_id) : [];
...
if (empty($slides)) {
  ...
  $slides = [
    'https://picsum.photos/id/1300/1600/900',
    'https://picsum.photos/id/1301/1600/900',
    'https://picsum.photos/id/1302/1600/900',
  ];
}
...
$intro_text = !empty($meta['intro_text'])
  ? $meta['intro_text']
  : 'Guerilla Marketing sorgt für überraschende, aufmerksamkeitsstarke Aktionen im öffentlichen Raum. WERBEINSEL entwickelt kreative Konzepte, die viral wirken und mit wenig Budget große Reichweite erzielen – von Ambient-Inszenierungen bis Flashmobs und Stunts.';
?>
...
<section id="<?php echo esc_attr($carousel_id); ?>" class="svc-hero-carousel">
  <div class="svc-hero-carousel__wrap">
    ...
    <div class="svc-hero-carousel__viewport">
      ...
      <!-- Strelice (izgled ostaje kao na ostalim stranicama) -->
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  // Preflight: validne slike → generiši dots
