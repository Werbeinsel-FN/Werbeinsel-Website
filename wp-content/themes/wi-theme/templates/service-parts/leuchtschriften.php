<?php
/**
 * Partial: Leuchtschriften – hero (naslov + slider) + intro tekst (FORCIRAN)
...
if (function_exists('wi_get_leucht_meta')) {
  $meta = wi_get_leucht_meta($page_id);
...
if (empty($slides)) {
  ...
  $slides = [
    'https://picsum.photos/id/140/1600/900',
    'https://picsum.photos/id/141/1600/900',
    'https://picsum.photos/id/142/1600/900',
  ];
}
...
/* 4) NASLOV – uvek forsiran (2 reda radi estetike) */
$intro_title = "LEUCHT\nSCHRIFTEN";

/* 5) INTRO TEKST – uvek forsiran (ignorišemo meta['intro_text']) */
$intro_text = 'Leuchtschriften machen Marken im Stadtraum unübersehbar: Profilbuchstaben, Kontur- und Vollacryl-Schriften mit energieeffizienter LED-Technik – exakt in Ihrem Corporate Design. WERBEINSEL plant, produziert und montiert inklusive Statik, Genehmigungen, elektrischer Abnahme und Wartung – langlebig, wetterfest und normgerecht.';
?>
