<?php
/**
 * Partial: Neonreklame – hero (naslov + slider) + intro (editabilno)
...
$meta = function_exists('wi_get_neon_meta') ? wi_get_neon_meta($page_id) : [];
...
if (empty($slides)) {
  ...
  $slides = [
    'https://picsum.photos/id/1900/1600/900',
    'https://picsum.photos/id/1901/1600/900',
    'https://picsum.photos/id/1902/1600/900',
  ];
}
...
$intro_title = "NEONREKLAME";

/* Intro tekst iz metabox-a + fallback (bez skraćivanja) */
$intro_text = !empty($meta['intro_text'])
  ? $meta['intro_text']
  : 'Neonreklame pružaju snažan vizuelni efekat i prepoznatljivost noću i danju. WERBEINSEL projektuje, proizvodi i montira prilagođene neon sisteme – od klasičnih staklenih cevi do savremenih LED-neona, uz servis i održavanje.';
?>
