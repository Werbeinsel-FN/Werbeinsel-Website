<?php
/**
 * Partial: Print Design – hero (naslov + slider) + intro tekst (FORCIRAN)
...
if (function_exists('wi_get_print_meta')) {
  $meta = wi_get_print_meta($page_id);
...
if (empty($slides)) {
  ...
  $slides = [
    ...
    'https://picsum.photos/id/1085/1600/900',
  ];
}
...
$intro_text = 'Print Design, der Eindruck macht: Von Visitenkarten, Broschüren und Flyern bis zu Katalogen, Plakaten und Verpackungen. WERBEINSEL gestaltet, produziert und liefert druckfertige Ergebnisse – farbverbindlich, haptisch stark und perfekt auf Ihr Corporate Design abgestimmt.';
?>
