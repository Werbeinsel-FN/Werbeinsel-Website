<?php
/**
 * Partial: Transit Advertising – hero (naslov + slider) + intro tekst (FORCIRAN)
...
if (function_exists('wi_get_transit_meta')) {
  $meta = wi_get_transit_meta($page_id);
...
if (empty($slides)) {
  // fallback – zameni svojim fotografijama po želji
  $slides = [
    'https://picsum.photos/id/1040/1600/900',
    'https://picsum.photos/id/1038/1600/900',
...
/* 5) INTRO TEKST – uvek forsiran (ignoriše meta['intro_text']) */
$intro_text = 'Transit Advertising macht Ihre Marke mobil: Auf Bussen, Straßenbahnen und Zügen wird Ihre Botschaft täglich in Bewegung gesehen – im Stadtbild, an Haltestellen und entlang stark frequentierter Strecken. WERBEINSEL plant, produziert und koordiniert Ihre Verkehrsmittelwerbung wirkungsvoll, rechtssicher und messbar – für maximale Sichtbarkeit unterwegs.';
?>
...
<section id="<?php echo esc_attr($carousel_id); ?>" class="svc-hero-carousel">
  <div class="svc-hero-carousel__wrap">
    ...
    <!-- Navigacija iznad viewporta, ostaje klikalna -->
