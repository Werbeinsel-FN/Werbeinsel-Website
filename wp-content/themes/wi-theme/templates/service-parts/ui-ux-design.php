<?php
/**
 * Partial: UI/UX Design – hero (naslov + slider) + intro (editabilno)
...
$meta = function_exists('wi_get_uiux_meta') ? wi_get_uiux_meta($page_id) : [];
...
if (empty($slides)) {
  ...
  $slides = [
    'https://picsum.photos/id/1800/1600/900',
    'https://picsum.photos/id/1801/1600/900',
    'https://picsum.photos/id/1802/1600/900',
  ];
}
...
$intro_text = !empty($meta['intro_text'])
  ? $meta['intro_text']
  : 'Wir gestalten nutzerzentrierte Interfaces und Journeys: Research, Informationsarchitektur, Wireframes, Prototyping und UI-Design – datenbasiert und markenkonsistent. WERBEINSEL verbindet Ästhetik, Usability und Conversion.';
?>
...
<section id="<?php echo esc_attr($carousel_id); ?>" class="svc-hero-carousel">
  <div class="svc-hero-carousel__wrap">
    ...
    <!-- VIEWPORT: nav + dots unutra, strelice centrirane po visini (izgled isti kao drugde) -->
