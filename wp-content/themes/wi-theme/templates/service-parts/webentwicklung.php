<?php
/**
 * Partial: Webentwicklung – hero (naslov + slider) + intro tekst (FORCIRAN)
...
$intro_text = 'Webentwicklung, die schnell, sicher und skalierbar ist: von performanten Websites über modulare CMS-Lösungen bis zu maßgeschneiderten Webanwendungen. WERBEINSEL konzipiert, entwickelt und betreibt Ihre digitale Präsenz inklusive UX, SEO, Tracking und Hosting – messbar, wartbar und zukunftssicher.';
?>
...
<section id="<?php echo esc_attr($carousel_id); ?>" class="svc-hero-carousel">
  <div class="svc-hero-carousel__wrap">
    ...
    <!-- Navigacija/dots iznad viewporta (klikalni) -->
